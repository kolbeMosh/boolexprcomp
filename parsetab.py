...
_lr_productions = [
  ...
  ('sentence -> LPAREN declarations COMMA expr RPAREN','sentence',5,'p_sentence','boolexpr1.py',75),
  ('declarations -> LBRACK RBRACK','declarations',2,'p_declarations','boolexpr1.py',80),
  ('declarations -> LBRACK varlist RBRACK','declarations',3,'p_declarations','boolexpr1.py',81),
  ('varlist -> varlist COMMA VAR','varlist',3,'p_varlist','boolexpr1.py',85),
  ('varlist -> VAR','varlist',1,'p_varlist','boolexpr1.py',86),
  ('expr -> T','expr',1,'p_expr_literal','boolexpr1.py',97),
  ('expr -> F','expr',1,'p_expr_literal','boolexpr1.py',98),
  ('expr -> NOT expr','expr',2,'p_expr_not','boolexpr1.py',102),
  ('expr -> expr AND expr','expr',3,'p_expr_and','boolexpr1.py',106),
  ('expr -> expr OR expr','expr',3,'p_expr_or','boolexpr1.py',111),
  ('expr -> VAR','expr',1,'p_expr_var','boolexpr1.py',116),
]
